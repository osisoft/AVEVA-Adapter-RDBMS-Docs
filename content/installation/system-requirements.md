...
<!-- Mark Bishop 4/16: "Arm" should be capitalized to "ARM". Changed in table above. -->
...
When collecting data through ODBC (Open Database Connectivity) <!-- Mark Bishop 4/16: This acronym isn't common enough to use it without defining it.-->, PI Adapter for RDBMS requires that the appropriate ODBC driver for your data source is properly installed and configured.