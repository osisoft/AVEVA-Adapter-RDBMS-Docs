...
PI Adapter for RDBMS is a data-collection component that collects time-series data and sends it to configured OMF (OSIsoft Message Format) endpoints in OSIsoft Cloud Services or PI Servers. The time-series data can originate from any relationship database management system (RDBMS) that supports Open Database Connectivity (ODBC) drivers.
